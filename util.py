...
def sample_Z(batch, z_dim , sampler = 'mix_gauss', num_class = 10, n_cat = 1, label_index = None):
...
def sample_labelled_Z(batch, z_dim, sampler = 'mix_gauss', num_class = 10,  n_cat = 1, label_index = None):
...
if __name__=='__main__':
    ...
    l = sample_Z(64, 38, sampler = 'mix_gauss',num_class = 8, n_cat = 1, label_index = None)
    print(l)
